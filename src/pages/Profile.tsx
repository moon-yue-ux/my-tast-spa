...
import { MOON_ADDRESS, MOON_COIN_ABI } from "@/abi/moonCoin";
...
export default function Profile() {
	...
	const moonBalance = useMemo(() => {
		try {
			return moonBalData
				? Number(formatUnits(moonBalData as bigint, 18)).toFixed(6)
				: "-";
		} catch {
			return "-";
		}
	...
	return (
		<section>
			...
			<div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm mb-6">
				...
				<div className="font-mono break-all mb-4 text-slate-800">
					{walletState.address ?? "未连接"}
				</div>
